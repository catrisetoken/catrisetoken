...
contract CatRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x00FC9f7a643762360d87759280C8f560262E382D));
    address payable public devWallet =
        payable(address(0x5cE0665b7f5FCE814e0f09907fEfD30b4eD982D4));
    address public liquidityReceiver =
        0x54336729781B0c34DfF727A5a9f6bb8da9B5000E;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "CatRise";
    string private _symbol = "CRISE";
